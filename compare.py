...
def getDist(pixel1,pixel2):
	x1 = (pixel1[0][2]-pixel1[0][0])
	y1 = (pixel1[0][1]-pixel1[0][3])
	x2 = (pixel2[0][2]-pixel2[0][0])
	y2 = (pixel2[0][1]-pixel2[0][3])
...
def compareImages(image1,image2):
	...
	image1Pixels = dice(image1,squareSize = 100) # using 100 right now, but have to find a better way to determine squareSize
	image2Pixels = dice(image2,squareSize = 100)
	match = -1
	dist = -1
	color = 120
